...
import * as iaccesstyles from './iaccess.module.css';
...
function Iaccess() {
    return (
        <Layout>
            ...
            <header className={`pageBanner ${iaccesstyles.iaccess}`}>
            ...
            <section className={iaccesstyles.iaccessCont}>
                <div className={`container-fluid container-fluid-sm container-fluid-md container-lg ${iaccesstyles.iaccessTop}`}>
                ...
                <div className={`container-fluid container-fluid-sm container-fluid-md container-lg ${iaccesstyles.iaccessContTwo}`}>
